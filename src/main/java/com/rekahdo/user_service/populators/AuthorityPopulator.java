...
public class AuthorityPopulator {
    ...
    private void insertIntoRepository() {
        ...
        service.assignAuthority(1L, new AssignAuthority(AuthorityRole.ADMIN, null), null);
        service.assignAuthority(2L, new AssignAuthority(AuthorityRole.MODERATOR, null), null);
        service.assignAuthority(3L, new AssignAuthority(AuthorityRole.EDITOR, null), null);
    }
